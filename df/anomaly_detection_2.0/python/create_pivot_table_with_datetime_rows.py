...
class ExecutionHandler(BaseExecutionHandler):
    ...
    def execute(self, data: pd.DataFrame, datetime_column, columns, values, sql_filter='optional', value_type=None):
        ...
        try:
            ...
            if operation_type == 'count_percentage':
                table = pd.pivot_table(data, values=values, index=[datetime_column],
