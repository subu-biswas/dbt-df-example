...
Output:
    - Data in the form of dataframe with the indicator column showing if the string is in lower case
"""
import pandas as pd
    ...
    def execute(self, data: pd.DataFrame, columns=None):
        try:
            for i in range(len(columns)):
                ...
                data[columns[i] + '_valid_islower'] = data[columns[i]].str.islower()
